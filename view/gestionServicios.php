...
<body>
    ...
    <div class="gestionServicios">
        ...
        <form action="darDeBajaServicio.php" method="POST">
            <div class="servicios">
                <?php
            ...
            <script>
                function modificarServicio() {
                    ...
                    window.location.href = `modificarServicioFormulario.php?id_servicio=${idServicio}`;
                }
            </script>
            <div class="buttons">
                <button type="button" onclick="window.location.href='darAltaServicioFormulario.php';">Dar de alta nuevo servicio</button>
