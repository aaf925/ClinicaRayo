...
<head>
    ...
    <script>
        function actualizarHorasDisponibles() {
            ...
            xhr.open('GET', 'obtenerHorasOcupadas.php?fecha=' + encodeURIComponent(fecha), true);
            xhr.onload = function () {
                if (xhr.status === 200) {
        ...
        function modificarCita(idCita) {
            ...
            window.location.href = `modificarCitaFormulario.php?id_cita=${idCita}`;
        }
    </script>
                    ...
                    for ($semana = 0; $semana < 6; $semana++) {
                        ...
                        for ($diaSemana = 1; $diaSemana <= 7; $diaSemana++) {
                            if ($semana === 0 && $diaSemana < $primerDiaSemana || $diaActual > $diasEnMes) {
                                ...
                                $resultadoCitas = $conexion->query($consultaCitas);
