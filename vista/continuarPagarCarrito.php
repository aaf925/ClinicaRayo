...
if (!$row_pedido || !$row_pedido['total']) {
    echo "<script>alert('No hay pedido en proceso.'); window.location.href='../vista/carrito.php';</script>";
    exit();
}
...
<body>
    <div class="contenedor">
        ...
        <!-- Formulario de pago -->
        <form action="../vista/procesarPago.php" method="POST" class="formulario" onsubmit="return validarFormulario()">
            ...
            <div class="botones">
                ...
                <button type="button" class="boton boton-cancelar" onclick="window.location.href='../vista/carrito.php'">Cancelar</button>
            </div>
        </form>
    </div>
</body>
