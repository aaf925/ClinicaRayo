...
<body>
    ...
    <div class = "formulario">
        ...
        <div class = "inputsFormulario">
            <form action="../vista/darAltaUsuario.php" method="post" enctype="multipart/form-data" onsubmit="validarFormulario(event);">
                ...
                <div class="botonesFormulario">
                    <button class="botonCancelar" type="button" onclick="window.location.href='../vista/gestionUsuarios.php';">Cancelar</button>
                    <button class = "botonGuardar" type="submit">Guardar</button>
                </div>
            </form>
            <?php
                include('../vista/darAltaUsuario.php');
            ?>
        </div>
    </div>
    <!-- Modal -->
    <?php if (isset($_GET['success']) && $_GET['success'] === 'true'): ?>
    <div class="modal-overlay" onclick="window.location.href='../vista/gestionUsuarios.php';">
        <div class="modal">
