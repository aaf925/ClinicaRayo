    ...
    if ($resultado && $fila = $resultado->fetch_assoc()) {
        ...
        <head>
            ...
            <style>
                ...
                .inputNombre, .inputPrecio, .inputCantidad, .inputCategoria {
                    width: 400px;
                }
                ...
                <div class="inputsFormulario">
                    <form action="guardarModificacionProducto.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class = "inputNombre">
                            ...
                            <br>
                            <input type="text" id="nombre" name="nombre" value="<?php echo htmlspecialchars($fila['nombre']); ?>" placeholder="Ingrese el nombre del producto" required>
                        </div>

                        <div class = "inputPrecio">
                            <label for="precio">Precio:</label>
                            <br>
                            <input type="double" id="precio" name="precio" min="0" value="<?php echo htmlspecialchars($fila['precio']); ?>" placeholder="Ingrese el precio del producto" required>
                        </div>

                        <div class = "inputDescripcion">
                            <label for="descripcion">Descripci&oacute;n:</label>
                            <br>
                            <textarea type="text" id="descripcion" name="descripcion" required placeholder="Ingrese la descripci&oacute;n del producto"><?php echo htmlspecialchars($fila['descripcion']); ?></textarea>
                        </div>

                        <div class="inputCategoria">
                            <label for="categoria">Categor&iacute;a:</label>
                            <br>
                            <input type="text" id="categoria" name="categoria" value="<?php echo htmlspecialchars($fila['categoria']); ?>" required placeholder="Ingrese la categor&iacute;a del producto">
                        </div>

                        <div class = "inputCantidad">
                            <label for="cantidad" id="cantidad">Cantidad:</label>
                            <br>
                            <input type="number" id="cantidad" name="cantidad" value="<?php echo htmlspecialchars($fila['stock']); ?>" required min="1">
                        </div>
